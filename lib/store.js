  ...
  teams: [
    ...
    },
    {
      ...
      members: [
        ...
        { name: 'Thamil Selvan P', roll: '712523205002' },
        { name: 'D Dinesh',       roll: '712523205005' },
      ],
    },
    {
      id: 'team3',
      name: 'Team Gamma',
      members: [
        { name: 'Diya Angelin S.P', roll: '712523205003' },
        { name: 'Sidharth',      roll: '712523205008' },
    ...
    },
    {
      ...
      name: 'Team Delta',
      members: [
        { name: 'Ram Kishore',     roll: '712523205012' },
    ...
    },
    {
      ...
      name: 'Team Epsilon',
      members: [
        { name: 'Surya Y"',   roll: '712523205018' },
...
export function saveData(d) { writeData(d); }
...
export function castVote(data, teamId, voterRoll, score) {
